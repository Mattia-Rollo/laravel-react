    ...
    return (
        <form onSubmit={submit} className="flex flex-col w-3/12">
            ...
            <input
                id="name"
                type="text"
                className={errors.name && "bg-orange-500"}
                value={data.name}
            ...
            <input
                id="description"
                type="text"
                className={errors.description && "bg-orange-500"}
            ...
            <button
                type="submit"
                disabled={processing}
                className="dark:text-white dark:bg-slate-500 p-2 rounded mt-2 dark:hover:bg-slate-700"
            >
                Salva
            </button>
            {progress && (
